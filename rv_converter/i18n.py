...
TRANSLATIONS = {
    "en": {
        ...
        "file_not_supported": "Error: File '{}' has unsupported format. Supported: json, jsonl, csv, xlsx.",
        "file_read_error": "Error: An error occurred while reading the file: {}",
        "filename_help": "Path to input file (JSON, JSONL, CSV, XLSX)",
        ...
        "program_description": "Universal data converter (JSON/JSONL/CSV/XLSX)",
        "sheet_name_with_chunk": "Sheet {}_{}",
        "sheet_name": "Sheet {}",
        "sort_by_help": "Key for sorting",
        "total_sheets_columns": "Total sheets: {}\nTotal columns: {}",
        "type_help": "Output format (xlsx, csv, json, jsonl)",
        "unsupported_file_type": "Unsupported file type: {}. Supported types: xlsx, csv, json, jsonl",
    ...
    "ru": {
        ...
        "file_not_supported": "Ошибка: Файл '{}' имеет неподдерживаемый формат. Поддерживаемые: json, jsonl, csv, xlsx.",
        "file_read_error": "Ошибка: Произошла ошибка при чтении файла: {}",
        "filename_help": "Путь до входного файла (JSON, JSONL, CSV, XLSX)",
        ...
        "program_description": "Универсальный конвертер данных (JSON/JSONL/CSV/XLSX)",
        "sheet_name_with_chunk": "Лист {}_{}",
        "sheet_name": "Лист {}",
        "sort_by_help": "Ключ для сортировки",
        "total_sheets_columns": "Всего листов: {}\nВсего столбцов: {}",
        "type_help": "Формат выходного файла (xlsx, csv, json, jsonl)",
        "unsupported_file_type": "Неподдерживаемый тип файла: {}. Поддерживаемые типы: xlsx, csv, json, jsonl",
